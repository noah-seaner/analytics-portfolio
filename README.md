...
Welcome to my analytics portfolio! This repository contains a curated selection of projects that reflect my interests in data analysis, statistical modeling, and sports analytics. I work with tools like Excel, Tableau, and R to explore datasets, build models, and create dashboards that turn raw data into actionable insights.
...
- Excel for KPI development, data transformation, and exploratory analysis
- Tableau for interactive dashboards and data visualization
- Focus on translating analytical findings into clear, decision-oriented insights
