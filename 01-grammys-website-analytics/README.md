...
## Objective
To transform website analytics data into meaningful business KPIs and evaluate how grammy.com and recordingacademy.com performed in terms of traffic, engagement, and user behavior, while providing data-driven recommendations for improvement.

## Data and Tools
- Tool: Microsoft Excel
- Data: Website traffic and engagement metrics for grammy.com and recordingacademy.com (2017-2023)
- Additional comparison: Competitor site (theAMAs.com)
- Methods: PivotTables, KPI calculations, time-series analysis, and A/B testing

## Methods

### KPI Development & Data Transformation
- Cleaned and structured raw traffic data in Excel
- Calculated key performance indicators including page views, sessions, bounced sessions, pages per session, and average session duration
- Aggregated metrics using PivotTables for comparison across sites and time periods.

### Trend Analysis
- Created a line chart showing daily visitors to grammy.com from January 2017 to May 2023
- Evaluated average session duration and mobile visitor share across both sites
- Benchmarked key KPIs (pages per session, bounce rate, average time on site) against competitor data from theAMAs.com

### Statistical Testing
- Conducted an A/B test comparing pages per session between grammy.com and recordingacademy.com
